...
public class Util {
	...
	/*
	 * Compute the shortest distance between line segment P1, P2, to point P3 using
	 * generalized parameterization for the point on the segment p = P1(1-u) + P2(u)
	 * , u on [0.1]
	 * 
	 * Method copied the java approach from answer 4 of this questions:
	 * http://stackoverflow.com/questions/849211/shortest-distance-between-a-point-
	 * and-a-line-segment
	 */
	...
	static Location[] targets = { new Location(550, 550), new Location(650, 650), new Location(750, 750),
			new Location(850, 850), new Location(950, 950) };
...
//		return new Location(10 + randomGenerator.nextInt(AntWorld.HEIGHT - 20),
